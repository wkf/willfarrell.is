...
var qg=If(document.getElementsByTagName("html"))[0],rg=If(document.getElementsByClassName("page"))[0],sg=If(document.getElementsByClassName("content"))[0],tg=If(rg.getElementsByTagName("nav"))[0],ug=If(rg.getElementsByTagName("header"))[0],vg=If(document.getElementsByClassName("menu"))[0],wg=If(vg.getElementsByClassName("content"))[0],xg=If(vg.getElementsByTagName("nav"))[0],yg=If(vg.getElementsByTagName("header"))[0],zg=If(yg.getElementsByTagName("hr"))[0];
...
function Dg(a){var b=Bg(ug);R.b(b,0,null);b=R.b(b,1,null);return new Xa(null,2,[Ef,a,xf,b-3*a],null)}function Eg(a){var b=Bg(yg);R.b(b,0,null);b=R.b(b,1,null);return new Xa(null,2,[Af,a,Bf,b-3*a],null)}
function Fg(){var a=O.c?O.c(Z):O.call(null,Z),b=bd(a)?Qc.a(Ld,a):a,a=T.a(b,vf),c=T.a(b,Ff),d=T.a(b,Cf),b=T.a(b,of),e=Ag();R.b(e,0,null);for(var e=R.b(e,1,null),a=v(a)?new W(null,2,5,ke,[b,d],null):v(c)?new W(null,2,5,ke,[b,e],null):new W(null,2,5,ke,[e,d],null),c=R.b(a,0,null),a=R.b(a,1,null),d=I(qf.c(O.c?O.c(Z):O.call(null,Z))),b=null,f=e=0;;)if(f<e){var g=b.t(null,f),k=R.b(g,0,null),g=R.b(g,1,null);c>=g?Lf.a(qg,k):Mf.a(qg,k);f+=1}else if(d=I(d))Vc(d)?(e=Xb(d),d=H(d),b=e,e=Q(e)):(e=L(d),b=R.b(e,
...
Qc.a(Wc,Vd.a(b,Ud.c("")));return Nf(a,e)}a.l=1;a.i=function(a){var d=L(a);a=M(a);return b(d,a)};a.f=b;return a}(),Kg=new W(null,5,5,ke,[new W(null,3,5,ke,[window,"resize",Gg],null),new W(null,3,5,ke,[window,"scroll",Fg],null),new W(null,3,5,ke,[vg,["transitionend","webkitTransitionEnd","msTransitionEnd","oTransitionEnd"],function(a){return function(b){return qc.a(b.target,b.currentTarget)?a.c?a.c(b):a.call(null,b):null}}(function(){if(v(vf.c(O.c?O.c(Z):O.call(null,Z)))){Qd.j(Z,Nc,vf,!1);if(v(Ff.c(O.c?
O.c(Z):O.call(null,Z))))return Mf.a(qg,yf),Qd.j(Z,Nc,Ff,!1);Jg.f(xg,Ic(["position","top"],0));Jg.f(zg,Ic(["position","top"],0));Mf.a(qg,wf);return Qd.j(Z,Nc,Ff,!0)}return null})],null),new W(null,3,5,ke,[If(rg.getElementsByClassName("ellipsis"))[0],"click",Hg(function(){if(v(vf.c(O.c?O.c(Z):O.call(null,Z))))return null;var a=Ag(),b=R.b(a,0,null),a=R.b(a,1,null),c=O.c?O.c(Z):O.call(null,Z),c=bd(c)?Qc.a(Ld,c):c,c=T.a(c,Cf);Qd.f(Z,Nc,of,a,Ic([vf,!0],0));Ig.f(rg,Ic(["top",Cg(-a)],0));Lf.f(qg,Df,Ic([wf],
0));Jg.f(vg,Ic(["top"],0));return window.scroll(b,c)})],null),new W(null,3,5,ke,[If(vg.getElementsByClassName("ellipsis"))[0],"click",Hg(function(){if(v(vf.c(O.c?O.c(Z):O.call(null,Z))))return null;var a=Ag(),b=R.b(a,0,null),a=R.b(a,1,null),c=O.c?O.c(Z):O.call(null,Z),d=bd(c)?Qc.a(Ld,c):c,e=T.a(d,Gf),c=T.a(d,of),d=T.a(d,zf),f=bd(e)?Qc.a(Ld,e):e,e=T.a(f,Bf),f=T.a(f,Af);Qd.f(Z,Nc,Cf,a,Ic([vf,!0],0));a>=f&&Ig.f(xg,Ic(["position","absolute","top",Cg(a)],0));a>=e&&eb(d)&&(d=nf.c(O.c?O.c(Z):O.call(null,
Z)),Ig.f(zg,Ic(["position","absolute","top",Cg(a+2*d)],0)));Lf.a(qg,yf);Ig.f(vg,Ic(["top",Cg(-a)],0));Mf.a(qg,Df);Jg.f(rg,Ic(["top"],0));return window.scroll(b,c)})],null)],null);
